/* Pain PT — Components (PPTComponents namespace) */
window.PPTComponents = (function () {
  const icons = {
  ...
  function renderHero({ eyebrow='', title='', sub='', primaryCTA=null, secondaryCTA=null }={}) {
    ...
    return `<section class="hero"><div class="hero-inner">
      ${eyebrow?`<div class="hero-eyebrow">${icon('zap')}${eyebrow}</div>`:''}
  ...
  function renderCheckList(items=[]) {
    return `<ul class="check-list">${items.map(i=>`<li class="check-item"><div class="check-dot">${icon('check')}</div><span>${i}</span></li>`).join('')}</ul>`;
  }
    ...
    return `<div class="footer-inner">
      <div class="footer-top">
        <div class="footer-brand">
          <a class="brand" href="#home" data-route="home"><span class="brand-mark">PPT</span><span class="brand-name">Pain PT</span></a>
          <p class="footer-brand-desc">Training structure, discipline, and coaching support in one platform. Built for clients who want to improve with accountability.</p>
        </div>
        <div class="footer-col"><div class="footer-col-title">Platform</div><ul class="footer-links">
          <li><a href="#features"      data-route="features">The System</a></li>
          <li><a href="#safety"        data-route="safety">Safe Training</a></li>
        ...
        <div class="footer-col"><div class="footer-col-title">Start</div><ul class="footer-links">
          <li><a href="#contact" data-route="contact">Coaching Interest</a></li>
          <li><a href="#contact" data-route="contact">Beta Access</a></li>
          <li><a href="#partners" data-route="partners">Partner With Us</a></li>
        </ul></div>
      </div>
      <div class="footer-bottom">
        <p class="footer-legal">&copy; 2025 Pain PT. All rights reserved.</p>
