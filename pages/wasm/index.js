...
export default {
  ...
  page: function () {
    ...
    <section>
      ...
      <p>Using WebAssembly, you can speed up key components of your server logic. Using Vercel Edge Functions, you can bring that to the edge. This allows developers to build more calculation intensive logic in languages such as C, C++, and Rust that gets pushed even closer to users.</p>
