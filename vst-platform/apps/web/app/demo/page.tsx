  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const res = await fetch('/api/leads', {
        ...
        body: JSON.stringify({ ...form, source: 'demo', tier: 'enterprise' }),
      });
      ...
      setStatus('error');
      setErrMsg('Unable to submit. Please check your connection and try again.');
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        {status === 'success' ? (
          <div className="bg-[#1A2540] border border-[#1E2D4A] rounded-xl p-8 text-center">
            ...
            <h2 className="text-white font-semibold text-lg mb-2">Demo request received</h2>
          ...
          <div className="bg-[#1A2540] border border-[#1E2D4A] rounded-xl p-8">
            <h1 className="text-white font-semibold text-2xl mb-1">Book a demo</h1>
            <p className="text-[#8A99B8] text-sm mb-8">
              See the full VST control system in a live walkthrough with our team.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0B1120] border border-[#2C3E60] rounded px-4 py-2.5 text-sm text-white placeholder-[#8A99B8] focus:outline-none focus:border-[#1D6FF2] transition-colors resize-none"
                  placeholder="e.g. policy compliance, duty of care, cost visibility…"
                />
              </div>
